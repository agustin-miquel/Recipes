...
public class WebInitializer implements ServletContextInitializer { // WebApplicationInitializer {
    ...
    public void onStartup(ServletContext servletContext) throws ServletException {
        ...
        // Not required: already register in Application configure method:
        ...
        javax.servlet.FilterRegistration.Dynamic fr2 = servletContext.addFilter("myFilter", new com.test.recipes.LogFilter());
        fr2.addMappingForUrlPatterns(null, true, "/*");
    }
